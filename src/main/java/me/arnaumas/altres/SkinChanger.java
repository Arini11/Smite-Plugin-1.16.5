...
public class SkinChanger {
    ...
    private void reloadPlayer(CraftPlayer cPlayer) {
        ...
        for (Player p: Bukkit.getServer().getOnlinePlayers()) {
            ...
            if (p.getUniqueId() != cPlayer.getPlayer().getUniqueId()) {
                ...
                Bukkit.getServer().getScheduler().runTask(UhcMain.getInstance(), () -> p.hidePlayer(cPlayer.getPlayer()));
                Bukkit.getServer().getScheduler().runTaskLater(UhcMain.getInstance(), () -> p.showPlayer(cPlayer.getPlayer()), 5);
            }
    ...
    public void rotateSkinsAsync() {
        ...
        }.runTaskAsynchronously(UhcMain.getInstance());
    }
